...
MS_hist = px.histogram(df_mj_no_duplicates_ec,x="ESTADO_CIVIL",y="count",nbins=50,hover_data=["ESTADO_CIVIL","count"],color="ESTADO_CIVIL")
...
EL_hist = px.histogram(df_mj_no_duplicates_el,x="NIVEL_EDUCATIVO",y="count",nbins=50,hover_data=["NIVEL_EDUCATIVO","count"],color="NIVEL_EDUCATIVO")
...
ET_hist = px.histogram(df_mj_etn,x="CONDIC_EXPECIONAL",y="count",nbins=50,hover_data=["CONDIC_EXPECIONAL","count"],color="CONDIC_EXPECIONAL")
...
MA_hist = px.histogram(df_mj_men_hg,x="EDAD",y="count",nbins=50,hover_data=["EDAD","count"],color="EDAD")
...
WA_hist = px.histogram(df_mj_women_hg,x="EDAD",y="count",nbins=50,hover_data=["EDAD","count"],color="EDAD")
